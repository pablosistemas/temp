...
def MAKER_DST_MAC_HI_REG ():        
    return 0x2000000

def MAKER_DST_MAC_LO_REG ():        
    return 0x2000004

def MAKER_SRC_MAC_HI_REG ():        
    return 0x2000008

def MAKER_SRC_MAC_LO_REG ():        
    return 0x200000c

def MAKER_ETHERTYPE_REG ():         
    return 0x2000010

def MAKER_IP_DST_REG ():            
    return 0x2000014

def MAKER_IP_SRC_REG ():            
    return 0x2000018

def MAKER_UDP_SRC_PORT_REG ():      
    return 0x200001c

def MAKER_UDP_DST_PORT_REG ():      
    return 0x2000020

def MAKER_OUTPUT_PORT_REG ():       
    return 0x2000024

def MAKER_NUM_EVT_PKTS_SENT_REG (): 
    return 0x2000028

def MAKER_ENABLE_REG ():            
    return 0x200002c
...
__main__.nf_regmap.update({
    ...
    0x2000000 : "MAKER_DST_MAC_HI_REG",
    0x2000004 : "MAKER_DST_MAC_LO_REG",
    0x2000008 : "MAKER_SRC_MAC_HI_REG",
    0x200000c : "MAKER_SRC_MAC_LO_REG",
    0x2000010 : "MAKER_ETHERTYPE_REG",
    0x2000014 : "MAKER_IP_DST_REG",
    0x2000018 : "MAKER_IP_SRC_REG",
    0x200001c : "MAKER_UDP_SRC_PORT_REG",
    0x2000020 : "MAKER_UDP_DST_PORT_REG",
    0x2000024 : "MAKER_OUTPUT_PORT_REG",
    0x2000028 : "MAKER_NUM_EVT_PKTS_SENT_REG",
    0x200002c : "MAKER_ENABLE_REG",
