...
for iter in range(1):
   for i in range(NUM_PKTS):
      ...
      pkt = libPktTemp.make_TCP_pkt(pkt_len=pkt_len, src_MAC=DA, dst_MAC=SA, EtherType=0x800,dst_IP=DST_IP, 
            src_IP=SRC_IP, ttl=64, src_PORT = 5555, dst_PORT = 6666 , seq_NUM = i*(pkt_len-hdr_len+1) );
